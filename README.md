[![Code Scanning - Action](https://github.com/YaoweiMicrosoft/exercise-codeql-query-wei/actions/workflows/codeQL.yml/badge.svg?event=workflow_dispatch)](https://github.com/YaoweiMicrosoft/exercise-codeql-query-wei/actions/workflows/codeQL.yml)
